    ...
    <div class="contenedor">
        ...
        <div class="contenido">
            ...
            @foreach ($publicaciones as $publicacion)
                <div id="publicacion">
                    <div id="user">
                        <a href="{{ route('perfil',['id' => $publicacion->user_id]) }}">
                        <img src="{{URL::asset('images/'.$publicacion->image)}}">
                        <h2>@ {{$publicacion->nick}}</h2>
                        </a>
                    </div>
                    <div id="imagen">
                        <img src="{{URL::asset('images/'.$publicacion->image_path)}}">
                    </div>
                    <div id="cantidades">


                        {{-- detector de likes y comentarios --}}
                        <?php
                    ...
                    @if ($my_like == 1)
                    <button class="boton like" data-id = "{{$publicacion->id}}">Like</button>
                    @else
                    <button class="boton dislike" data-id = "{{$publicacion->id}}">Like</button>
                    @endif

                    <a href="{{route('comentarios',['id' => $publicacion->id])}}"><div class="boton">Comentar</div></a>
                </div>
            @endforeach
